...
MODULE_REGISTRY: dict[str, AbstractModule] = {
    ...
    "modules.dashboard.command_handler": DashboardCommandHandler,
    "modules.dashboard.recordings_service": RecordingsService,
...
COMMON_PIPELINE_MODULES: list[str] = [
    ...
    "modules.dashboard.command_handler",
    "modules.dashboard.recordings_service",
