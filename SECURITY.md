...
**Camera discovery (`spyoncino discover`)** — Optional “scan local subnets” probes many LAN addresses (TCP to the RTSP port). Use only on networks you own or are explicitly authorised to test; it can resemble port scanning to monitoring tools.
