#!/usr/bin/env bash
# Spyoncino Security System — launcher (run from repo root; path-safe when invoked from scripts/)
...
echo
echo "TIP: Edit data/config/recipe.yaml and data/config/secrets.yaml before first run"
